"""
Import script for Hisaishi – Merry-Go-Round of Life (Howl's Moving Castle)
==========================================================================
Source:  https://bitmidi.com/joe-hisaishi-merry-go-round-of-life-howls-moving-castle-mid
         (direct: https://bitmidi.com/uploads/63179.mid)
Raw file: songs/merry_go_round/raw/63179.mid
Output:  fingering/data_merry_go_round.json

Run from the project root:
    python3 songs/merry_go_round/import.py
...
RAW_MIDI           = Path(__file__).parent / "raw" / "63179.mid"
OUTPUT             = Path(__file__).parent.parent.parent / "fingering" / "data_merry_go_round.json"

VIOLIN_TRACK_INDEX = 2    # CH #1, GM program 40 (Violin), melody line
...
def main():
    ...
    data = {
        "label": "Hisaishi – Merry-Go-Round of Life",
        "bpm": 104,
        "sequence": sequence,
    }
